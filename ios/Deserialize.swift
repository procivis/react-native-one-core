...
func deserializeIdentifierRequest(identifierRequest: NSDictionary) throws -> CreateIdentifierRequestBindingDto {
  return CreateIdentifierRequestBindingDto(
...
func deserializeIdentifierDidRequest(identifierDidRequest: NSDictionary) throws -> CreateIdentifierDidRequestBindingDto {
  ...
  let paramsRaw: NSDictionary = try safeCast(identifierDidRequest.value(forKey: "params"));
  var params: [String: String] = [:];
  try paramsRaw.allKeys.forEach {
    let key: String = try safeCast($0);
    params[key] = paramsRaw.value(forKey: key) as? String;
...
func deserializeIdentifierListQuery(_ query: NSDictionary) throws -> IdentifierListQueryBindingDto {
  return IdentifierListQueryBindingDto(
    page: try safeCast(query.value(forKey: "page")),
    pageSize: try safeCast(query.value(forKey: "pageSize")),
    sort: try opt(query.value(forKey: "sort") as? String, deserializeEnum),
    sortDirection: try opt(query.value(forKey: "sortDirection") as? String, deserializeEnum),
...
extension IdentifierTypeBindingEnum: CaseIterable {
  public static var allCases: [IdentifierTypeBindingEnum] {
    return [.key, .did, .certificate]
  }
}
...
extension ExactIdentifierFilterColumnBindingEnum: CaseIterable {
  public static var allCases: [ExactIdentifierFilterColumnBindingEnum] {
    return [.name]
  }
}
