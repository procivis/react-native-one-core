...
class RSEKeyStorage: NativeKeyStorage {
    ...
    func generateKey(keyAlias: String) async throws -> GeneratedKey {
    ...
    func generateAttestationKey(keyAlias: String, nonce: String?) async throws -> ProcivisOneCore.GeneratedKey {
